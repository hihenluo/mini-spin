...
function Spin() {
  ...
  const handleStopSpinning = () => {
    ...
    if (winningPrize.includes('ZONK')) {
      ...
      resultMessage = `WOW! You won ${randomCoin} Coins! (Minting Token...)`;
    } else if (winningPrize.includes('TICKET')) {
      resultMessage = `SWEET! You got 1 free Ticket! (Minting Token...)`;
    } else {
      resultMessage = `CONGRATS! You won a ${winningPrize}! (Minting Token...)`;
    }
